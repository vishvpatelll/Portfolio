      ...
      <header className="header" ref={headerRef}>
        <Container>
          <div className="navigation d-flex align-items-center justify-content-between">
            <div className="logo"><h5><a href="#home">Vishv Patel</a></h5></div>
            ...
            <div className="nav__menu" ref={menuRef} onClick={menuToggle}>
                ...
                {navLink.map((item, index) => (
                    ...
                    <a href={item.url} className={active===item.url?'active':''} onClick={()=>{
                      setActive(item.url);
                      document.title="Vishv Patel | "+item.name }}>{item.name}</a>
                    </li>
                ))}
                </ul>
            ...
            <div className="nav__right d-flex align-items-center gap-4">
                <button className="btn contact__btn"><a href="#contact" onClick={()=>(document.title="Vishv Patel | Contact")}>let's Talk</a></button>
